...
@Service
public class PNDService extends ModuleService {

    @Autowired
    public PNDService(DataService dataService) {
        super(dataService);
    }

    public byte[] getPND901305(List<Map<String, String>> paramList, Map<String, String> additionalData) throws ExecutionException, InterruptedException {
